    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=home.models.upload_i)),
                ...
                ('status', models.CharField(default='Pending', max_length=63)),
            ],
        ),
        migrations.CreateModel(
            name='Donation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejected', models.ManyToManyField(blank=True, related_name='rejected', to='home.animal')),
                ('tickets', models.ManyToManyField(blank=True, related_name='tickets', to='home.animal')),
